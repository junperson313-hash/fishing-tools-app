...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "よく紹介される目安のひとつに「水深(m)×2≒重さ(g)」という計算があります(例: 水深30mなら60g前後)。このツールもこの目安をベースに、潮の速さで重さを調整して計算しています。ただし「水深とほぼ同じg数」というより軽めの目安を使う人もおり、絶対的な正解ではありません。実際には船が流れる速さや使用するタックルによっても変わるため、船長のアドバイスも参考にしてください。",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <section aria-labelledby="explain-heading" className="mt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-sea-600">
          タイラバは着底とその後の一定速度での巻き上げが重要な釣りです。軽すぎると仕掛けが流されて底が取りにくく、重すぎると不自然な動きになったり根がかりが増えたりします。このツールは「水深(m)×2≒重さ(g)」という、複数の釣り情報サイトで共通して紹介されている目安を基準に、潮の速さで加減する計算をしています。まずはこの目安から始め、着底までの時間やラインの角度を見ながら、その日の潮に合わせて軽く・重く調整していくのが基本的な考え方です。
        </p>
      </section>
