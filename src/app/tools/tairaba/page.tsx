...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "水深が浅いうちは「水深(m)×2≒重さ(g)」に近い伸び方をしますが、水深60m・80mと深くなるにつれて、この計算式ほどには重さが増えなくなっていきます(例えば水深100mでも、潮が緩ければ100g前後、速くても150g程度が目安で、単純計算の200gまでは必要にならないことが多いです)。このツールは、水深20/40/60/80/100mごとに潮の速さ別の目安をまとめた早見表をもとに計算しています。あくまで出発点の目安として使い、実際の当たり方・着底のしやすさで調整してください。",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <section aria-labelledby="explain-heading" className="mt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-sea-600">
          タイラバは着底とその後の一定速度での巻き上げが重要な釣りです。軽すぎると仕掛けが流されて底が取りにくく、重すぎると不自然な動きになったり根がかりが増えたりします。このツールは、水深20/40/60/80/100mの各段階で「遅い・普通・速い」の3パターンの目安をまとめた早見表をもとに計算しています。水深が深くなるほど、重さの増え方は緩やかになっていく点が特徴です。まずはこの目安から始め、着底までの時間やラインの角度を見ながら、その日の潮に合わせて軽く・重く調整していくのが基本的な考え方です。
        </p>
      </section>
