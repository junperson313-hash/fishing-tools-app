...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "号数はラインの太さ(糸の断面積)を表す単位、lbはラインが切れるまでの強さ(強力)を表す単位です。PEラインは同じ太さでも編み方や素材で強度が変わるため、号数とlbの関係はメーカーによって多少ズレがあります。このツールの数値は、多くのメーカーで採用されている標準的な目安値をもとにしています。",
  },
  {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <section aria-labelledby="explain-heading" className="mt-8">
        ...
        <p className="mt-2 text-sm leading-relaxed text-sea-600">
          PEラインは複数の原糸を編み込んで作られる釣り糸で、同じ太さのナイロン・フロロカーボンラインよりも強度が高いのが特徴です。号数は太さの単位ですが、編み方やメーカーの技術によって強度が変わるため、号数だけで正確な強さは決まりません。このツールの換算値は、多くの製品で目安とされている標準的な数値です。実際の釣行では、必ずライン本体やパッケージに記載された強力表示を確認してください。
        </p>
      </section>
